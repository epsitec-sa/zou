...
[<bundle>]
  ...
  └─[zou]
     ...
     ├─ Directory.Packages.net4.props¹      # freezed versions for net4.8
     ├─ Directory.Packages.net8.props¹      # freezed versions for net8.0
     ├─ Directory.Packages.net9.props¹      # freezed versions for net9.0
     ├─ Directory.Packages.net10.props¹     # freezed versions for net10.0
     └─[Nupkg]
        ├─ Nupkg.csproj   # nuget packages management project
        └─ Nupkg.sln      # nuget packages management solution

¹ generated by 'zou nupkg'
```
